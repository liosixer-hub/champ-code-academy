...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-DtC47MIx.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BToVT9TW.js', import.meta.url).href),import:true},'react/jsx-runtime':{get:()=>()=>__federation_import(new URL('__federation_shared_react/jsx-runtime-LUgpR0Zf.js', import.meta.url).href),import:true},'zustand':{get:()=>()=>__federation_import(new URL('__federation_shared_zustand-C5R0wPVe.js', import.meta.url).href),import:true}};
