const currentImports = {};
      ...
      let moduleMap = {
"./HomeApp":()=>{
      dynamicLoadingCss(["style-D0q1PE6Q.css"], false, './HomeApp');
      return __federation_import('./__federation_expose_HomeApp-FADNQ8v4.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
