...
function DashboardApp({ onBackClick }) {
  useAppStore();
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-md w-full space-y-8", children: [
    /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("h2", { className: "mt-6 text-center text-3xl font-extrabold text-gray-900", children: "Dashboard" }) }),
    /* @__PURE__ */ jsx("div", { className: "mt-8 space-y-6", children: /* @__PURE__ */ jsx("p", { className: "text-center text-gray-600", children: "This is the dashboard application. Start building your features here." }) })
  ] }) });
}
