...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-Dl2e77_C.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-CFMRiUlt.js', import.meta.url).href),import:true},'react/jsx-runtime':{get:()=>()=>__federation_import(new URL('__federation_shared_react/jsx-runtime-DOkVwsuO.js', import.meta.url).href),import:true},'zustand':{get:()=>()=>__federation_import(new URL('__federation_shared_zustand-CtTFrDI0.js', import.meta.url).href),import:true}};
